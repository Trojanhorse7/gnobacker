...
const Projects = () => {
  ...
  return (
		<div className="flex flex-col px-9 mb-7 width-[100%] bg-green-700 border-y-4 border-dotted border-green-200">
...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div id="projects" className="rounded-sm shadow-lg bg-green-200 w-[20rem] m-4">
      <Link to={'/projects/' + project.id}>
        <img
          src={project.imageURL}
          alt={project.title}
          className="rounded-xl h-[20rem] w-full object-fit"
        />
